...
int ieee80211softmac_handle_probe_resp(struct net_device *dev,
...
struct ieee80211softmac_network * ieee80211softmac_get_network_by_bssid(
	struct ieee80211softmac_device *mac, u8 *ea);
struct ieee80211softmac_network * ieee80211softmac_get_network_by_bssid_with_channel(
	struct ieee80211softmac_device *mac, u8 *ea, u8 channel );
