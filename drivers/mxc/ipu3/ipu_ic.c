...
void _ipu_ic_init_prpvf(ipu_channel_params_t *params, bool src_is_csi)
{
	...
	if (src_is_csi || !(params->mem_prp_vf_mem.outv_resize_ratio)) {
	...
	if (src_is_csi || !(params->mem_prp_vf_mem.outh_resize_ratio)) {
...
void _ipu_ic_init_prpenc(ipu_channel_params_t *params, bool src_is_csi)
{
	...
	/* Setup vertical resizing */
	if (src_is_csi || !(params->mem_prp_enc_mem.outv_resize_ratio)) {
	...
	/* Setup horizontal resizing */
	/* Upadeted for IC split case */
	if (src_is_csi || !(params->mem_prp_enc_mem.outh_resize_ratio)) {
