...
/* PMIC's ADC resolution is 10 bits */
#define	MAX_10BIT			((1 << 10) - 1)
#define MXCTS_DISPLAY_X_MAX 		MAX_10BIT
#define MXCTS_DISPLAY_Y_MAX 		MAX_10BIT
#define MXCTS_TOUCH_PRESSURE_MAX	MAX_10BIT
...
static int __init mxc_ts_init(void)
{
	...
	input_set_abs_params(mxc_inputdev, ABS_X, 0, MXCTS_DISPLAY_X_MAX, 0, 0);
	input_set_abs_params(mxc_inputdev, ABS_Y, 0, MXCTS_DISPLAY_Y_MAX, 0, 0);
	input_set_abs_params(mxc_inputdev, ABS_PRESSURE, 0, MXCTS_TOUCH_PRESSURE_MAX,
				0, 0);
