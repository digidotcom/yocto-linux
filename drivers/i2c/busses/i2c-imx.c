...
#if defined(CONFIG_I2C_IMX_RECOVER_FROM_STUCK)
static void i2c_imx_recover(struct imx_i2c_struct *i2c_imx)
{
	dev_err(&i2c_imx->adapter.dev, "trying to recover i2c bus...\n");

	if (i2c_imx->i2c_recover_from_stuck)
		i2c_imx->i2c_recover_from_stuck();
...
#if defined(CONFIG_I2C_IMX_RECOVER_FROM_STUCK)
	if (pdata)
		i2c_imx->i2c_recover_from_stuck = pdata->i2c_recover;
#endif
