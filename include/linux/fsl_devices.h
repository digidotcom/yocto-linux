...
/* +DIGI: This is different than 'mxs_platform_fb_data' that
 * lives in arch/arm/mach-mx28/include/mach/lcdif.h
 */
struct mxs_fb_platform_data {
	struct fb_videomode *mode;
	int num_modes;
	char *mode_str;
	u32 interface_pix_fmt;
...
struct mx28_lcd_pdata {
	struct mxs_fb_platform_data fb_pdata;
	void (*init) (struct mxs_fb_platform_data *);
	void (*deinit) (int);
	void (*bl_enable) (int);
};

struct mx28_lcds_plat_data {
	struct mx28_lcd_pdata *displays;
	int num_displays;
