...
#ifndef CONFIG_CCARDIMX28_DEFAULT_VIDEO_BPP
#define CONFIG_CCARDIMX28_DEFAULT_VIDEO_BPP	32
#endif
...
struct mxs_platform_bl_data {
	...
	int bl_gpio;
	int pwm;		/* PWM number to use */
	int inverted;		/* Whether backlight signal is inverted */
				      ...
				      u16 h_active, int enable_present)
{
	...
	__raw_writel(BM_LCDIF_CTRL1_RECOVER_ON_UNDERFLOW |
#if ((16 == CONFIG_CCARDIMX28_DEFAULT_VIDEO_BPP) || (24 == CONFIG_CCARDIMX28_DEFAULT_VIDEO_BPP))
		     BF_LCDIF_CTRL1_BYTE_PACKING_FORMAT(0xf),
#else
		     BF_LCDIF_CTRL1_BYTE_PACKING_FORMAT(7),	/* 32 bpp */
#endif
	...
	__raw_writel(BM_LCDIF_CTRL_DATA_SELECT |	/* data mode */
#if ((32 == CONFIG_CCARDIMX28_DEFAULT_VIDEO_BPP) || (24 == CONFIG_CCARDIMX28_DEFAULT_VIDEO_BPP))
		     BF_LCDIF_CTRL_WORD_LENGTH(3) |
#elif (18 == CONFIG_CCARDIMX28_DEFAULT_VIDEO_BPP)
		     BF_LCDIF_CTRL_WORD_LENGTH(2) |
#else
		     BF_LCDIF_CTRL_WORD_LENGTH(0) |	/* 16 bpp */
#endif
#if (24 == CONFIG_CCARDIMX28_DISP_DATABUS_WIDTH)
		     BF_LCDIF_CTRL_LCD_DATABUS_WIDTH(3) |
#elif (18 == CONFIG_CCARDIMX28_DISP_DATABUS_WIDTH)
		     BF_LCDIF_CTRL_LCD_DATABUS_WIDTH(2) |
#else
		     BF_LCDIF_CTRL_LCD_DATABUS_WIDTH(0) |	/* 16 bits */
#endif
