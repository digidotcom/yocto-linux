...
#include "mx28_wr21.h"
#endif
#include "../plat-mxs/icoll.h"
#include "mx28_gpio_pm.h"
#include "sleep.h"
...
#elif defined(CONFIG_MODULE_CCARDIMX28)
#elif defined(CONFIG_MACH_WR21)
	mx28_wr21_enet_io_lowerpower_enter();
#endif
	/*
...
#elif defined(CONFIG_MODULE_CCARDIMX28)
#elif defined(CONFIG_MACH_WR21)
	mx28_wr21_enet_io_lowerpower_exit();
#endif
}
...
{
#if defined(CONFIG_MACH_MX28EVK) || defined(CONFIG_MODULE_CCARDIMX28)
	/*
	 * The PSWITCH interrupt is enabled at do_standby, if the device
	...
	__raw_writel(BM_POWER_CTRL_ENIRQ_PSWITCH,
		REGS_POWER_BASE + HW_POWER_CTRL_SET);
#elif defined(CONFIG_MACH_CPX2) || defined(CONFIG_MACH_WR21)
