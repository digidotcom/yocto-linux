...
{
	if ( arch_id == MACH_TYPE_CCIMX51JS || arch_id == MACH_TYPE_CCIMX51) {
	...
	} else if ( arch_id == MACH_TYPE_CCIMX53JS || arch_id == MACH_TYPE_CCIMX53 ) {
...
static __inline__ void __arch_decomp_setup(unsigned long arch_id)
{
	...
	case MACH_TYPE_MX50_RDP:
		...
		break;
#ifdef CONFIG_MODULE_CCIMX5X
	case MACH_TYPE_CCIMX51JS:
	case MACH_TYPE_CCIMX51:
	case MACH_TYPE_CCIMX53JS:
	case MACH_TYPE_CCIMX53:
