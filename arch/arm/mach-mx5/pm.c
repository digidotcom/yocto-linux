...
static int __init pm_init(void)
{
	...
	if (cpu_is_mx51() || cpu_is_mx53()) {
		if ( cpu_is_mx51() ) {
			if (600000000 == ccimx5x_get_cpufreq_from_variant())
				suspend_param1 = (void *)SUSPEND_ID_MX51_600;
			else
				suspend_param1 = (void *)SUSPEND_ID_MX51_800;
		}
		else if ( cpu_is_mx53() ){
			suspend_param1 = (void *)SUSPEND_ID_MX53;
		}
